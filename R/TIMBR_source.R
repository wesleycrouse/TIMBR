...
#' @keywords internal
TIMBR2 <- function(y, prior.D, prior.M, prior.phi.b=1, samples=10000, samples.ml=10000, Z=NULL, W=NULL, verbose=T, stop.on.error=F){
...
#' @keywords internal
TIMBR.scan2 <- function(y, prior.D.all, prior.M=NULL, prior.phi.b=1, samples=100, samples.ml=100, Z=NULL, W=NULL, verbose=T, stop.on.error=F){
  P.all <- prior.D.all$P.all
  intervals <- prior.D.all$intervals
  ...
  for (j in 1:length(loci)){
    ...
    prior.D$P <- P.all[,,i]
    results <- TIMBR2(y, prior.D, prior.M, prior.phi.b, samples, samples.ml, Z, W, F, stop.on.error)
