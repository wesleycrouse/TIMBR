...
We call TIMBR using this prior and visualize the haplotype effects. Throughout this vignette, we only draw 1000 samples so that everything runs quickly. Note that many analyses will require additional samples. 
...
```
##           [,1]     [,2]     [,3]     [,4]     [,5]     [,6]     [,7]     [,8]
##  [1,] 58.81412 47.35295 58.81412 47.35295 47.35295 58.81412 58.81412 58.81412
##  [2,] 59.33509 47.66489 59.33509 47.66489 47.66489 59.33509 59.33509 59.33509
##  [3,] 58.72291 46.81218 58.72291 46.81218 46.81218 58.72291 58.72291 58.72291
##  [4,] 58.52690 47.07728 58.52690 47.07728 47.07728 58.52690 58.52690 58.52690
##  [5,] 58.32652 46.86259 58.32652 46.86259 46.86259 58.32652 58.32652 58.32652
##  [6,] 59.04195 46.60730 59.04195 46.60730 46.60730 59.04195 59.04195 59.04195
##  [7,] 59.00586 46.09110 59.00586 46.09110 46.09110 59.00586 59.00586 59.00586
##  [8,] 59.48680 48.17944 59.48680 48.17944 48.17944 59.48680 59.48680 59.48680
##  [9,] 58.47911 48.20291 58.47911 48.20291 48.20291 58.47911 58.47911 58.47911
## [10,] 58.52057 46.88753 58.52057 46.88753 46.88753 58.52057 58.52057 58.52057
```
...
```
##                   [,1]
## 0,1,2,1,1,2,0,0 0.1340
## 0,1,0,1,1,0,2,2 0.0629
## 0,1,0,1,1,2,0,0 0.0625
## 0,1,0,1,1,0,0,0 0.0477
## 0,1,2,1,1,3,0,0 0.0433
## 0,1,2,1,1,2,3,3 0.0324
## 0,1,2,1,1,0,2,2 0.0265
## 0,1,2,1,1,2,3,0 0.0252
## 0,1,0,1,1,2,3,3 0.0243
## 0,1,2,1,1,2,0,3 0.0186
```
...
```
##                   [,1]
## 0,1,0,1,1,0,0,0 0.5414
## 0,1,0,1,1,2,0,0 0.0819
## 0,1,2,1,1,2,0,0 0.0657
## 0,1,0,1,1,0,2,2 0.0284
## 0,1,0,1,1,0,2,0 0.0209
## 0,1,2,1,1,0,0,0 0.0204
## 0,1,0,2,1,0,0,0 0.0195
## 0,1,0,1,2,0,0,0 0.0183
## 0,1,0,2,2,0,0,0 0.0155
## 0,1,2,1,1,3,0,0 0.0138
```
...
```
##                   [,1]
## 0,1,0,1,1,0,0,0 0.6742
## 0,1,0,1,1,2,0,0 0.1375
## 0,1,0,1,1,0,2,0 0.0883
## 0,1,0,1,1,2,3,0 0.0629
## 0,1,0,1,1,2,2,0 0.0131
## 0,1,0,2,2,0,0,0 0.0031
## 0,1,2,1,1,3,4,0 0.0027
## 0,1,2,1,1,0,0,0 0.0026
## 0,1,2,1,1,3,0,0 0.0023
## 0,1,0,1,1,0,0,2 0.0017
```
