...
```{r}
results.hap <- TIMBR(y, prior.D, prior.M.hap, verbose=F, samples=1000, samples.ml=1000)
...
```{r}
results.biallelic <- TIMBR(y, prior.D, prior.M.biallelic, verbose=F, samples=1000, samples.ml=1000)
...
```{r}
results.uniform <- TIMBR(y, prior.D, prior.M.uniform, verbose=F, samples=1000, samples.ml=1000)
...
```{r}
results.crp <- TIMBR(y, prior.D, prior.M.crp, verbose=F, samples=1000, samples.ml=1000)
